...
st.markdown("""
    **AI-Powered Hydrological Forecasting**
    By Shaneel S. Sao, R.A.(Engineering)
    Under Guidence of Dr. M Selva balan, Additional Director
                    & Smt. Anuja Rajgoplan, 'Sci- C'
    Description:- its use  Random Forest Machine Learning model to estimate daily water loss 
    based on meteorological parameters. 
    *Developed for CWPRS AI Project implimentation Cell.*
""")
